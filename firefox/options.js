...
// Affichée en ligne dans about:addons (open_in_tab: false → onglet « Préférences »
// de la fiche de l'extension). L'environnement actif se choisit dans la popup ;
// ici on gère les définitions.
...
/** Suppression en deux temps — confirm() n'est pas fiable dans la page d'options embarquée d'about:addons. */
